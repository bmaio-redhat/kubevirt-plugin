...
export class CreateVmInstanceTypesComponent extends BaseComponent {
  ...
  private readonly _nameFilterInput = this.testId('item-filter').or(
  ...
  async addVolumeViaRegistry(
    ...
    try {
      ...
      const containerImageInput = this.testId('dialog-modal').getByTestId('volume-registry-container-source-input');
      ...
      const usernameInput = this.testId('dialog-modal').getByTestId('volume-registry-container-source-username');
      ...
      const passwordInput = this.testId('dialog-modal').getByTestId('volume-registry-container-source-password');
      ...
      const cronExpInput = this.testId('dialog-modal').getByTestId('volume-registry-retain-cron-expression');
  ...
  async filterVolumeByName(volumeName = 'fedora'): Promise<boolean> {
    try {
      const itemFilter = this.locator('.create-vm-instance-type-section').getByTestId('item-filter');
