...
export default class CreateVmCreateComponent extends BaseComponent {
  ...
  private readonly _diskBootSourceContainerSourceInput = this.testId('disk-boot-source-container-source-input');
  private readonly _diskBootSourceHttpSourceInput = this.testId('disk-boot-source-http-source-input');
