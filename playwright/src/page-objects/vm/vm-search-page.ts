...
export default class VmSearchPage extends PageCommons {
  private readonly _advSearchMemOperatorToggle = this.testId(
    'adv-search-mem-operator-toggle',
  );
  private readonly _advSearchNetwork = this.testId('adv-search-network');
  private readonly _advSearchVmProjectToggle = this.testId(
    'adv-search-vm-project-toggle',
  );
